...
Mobile.tap(findTestObject('Start page/Connect button/Sing in/Already signed up Sign in'), 0)
...
Mobile.tap(findTestObject('Start page/Connect button/Sing in/Sign in'), 0)
